...
class PetClassifier(nn.Module):
    def __init__(self):
        ...
        self.fc1 = nn.Linear(1024, 512) # 512 hidden neurons to learn and identify complex patt
        self.fc2 = nn.Linear(512, 37) # Second param matches no of sub-classes. 
        self.dropout = nn.Dropout(p=0.3) # It randomly sets 10% of the input units to 0 at each update during training time, which helps prevent overfitting. I set it up in anticipation of overfitting as a precautionary measure. 
